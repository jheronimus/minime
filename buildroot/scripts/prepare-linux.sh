...
BOOTSTRAP_PACKAGES="build-essential bison flex unzip rsync git curl ccache cmake mold zstd libelf-dev libssl-dev bc python3 python3-dev u-boot-tools cpio genimage mtools dosfstools lzip parted erofs-utils file wget libncurses-dev"
