...
if [ -f "${MINIME_ROOT}/packages/components/boards/common/initramfs-init.sh" ]; then
	cp -f "${MINIME_ROOT}/packages/components/boards/common/initramfs-init.sh" "${INITRD_STAGE}/init"
