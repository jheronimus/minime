...
#
# The device registry (packages/components/boards/<board>/traits/) is the single source of
...
# packages/components/boards/patches/manifest.md).

set -eu

ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
BOARDS_ROOT="$ROOT/packages/components/boards"
...
check_board() {
	...
	buildroot_cfg="$ROOT/packages/components/buildroot/external/configs/${board}.config"
